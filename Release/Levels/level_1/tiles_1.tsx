...
<tileset version="1.10" tiledversion="1.10.1" name="tiles_1" tilewidth="32" tileheight="32" tilecount="130" columns="10">
 <image source="tileset.png" width="320" height="416"/>
 <wangsets>
  <wangset name="Terrain" type="corner" tile="-1">
   ...
   <wangtile tileid="18" wangid="0,1,0,0,0,0,0,1"/>
   <wangtile tileid="19" wangid="0,0,0,0,0,0,0,1"/>
  </wangset>
  <wangset name="Deco" type="edge" tile="-1">
   <wangcolor name="Grass" color="#ff0000" tile="-1" probability="1"/>
   <wangcolor name="Bottom" color="#00ff00" tile="-1" probability="1"/>
   ...
   <wangtile tileid="6" wangid="0,0,1,0,0,0,0,0"/>
   <wangtile tileid="20" wangid="0,0,2,0,0,0,0,0"/>
   <wangtile tileid="21" wangid="0,0,2,0,0,0,2,0"/>
   <wangtile tileid="22" wangid="0,0,2,0,0,0,2,0"/>
   <wangtile tileid="23" wangid="0,0,2,0,0,0,2,0"/>
   <wangtile tileid="24" wangid="0,0,0,0,0,0,2,0"/>
  </wangset>
  <wangset name="Base Grass" type="corner" tile="-1">
